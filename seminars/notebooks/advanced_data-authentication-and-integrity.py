...
# # Seminar 06: Data Authentication and Integrity

# By purely encrypting data, we only ensure its **confidentiality**. However, there are other desirable security properties.

import secrets
from pv080_crypto import sha256_hash, chacha20_encrypt, chacha20_decrypt, create_mac, verify_mac
...
# **Task 1.0**: For this advanced notebook, you can write your own functions for downloading a file and calculating XOR.
...
def download(url: str) -> str:
    ...
    :returns: The name of the downloaded file, which is extracted from the URL.

    Example:

    >>> filename = download('https://example.com/path/to/file.txt')
